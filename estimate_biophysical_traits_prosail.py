...
wvp = 25. # water vapour
sza = 37.5 # sun zenith angle MEAN_SOLAR_ZENITH_ANGLE
saa = 180 # sun azimuth angle MEAN_SOLAR_AZIMUTH_ANGLE
vza = 25 # sensor viewing angle

# specify date
date_obj = dt.datetime(2023, 8, 5, 10, 30)

skyl = get_diffuse_radiation_6S(aot, wvp, sza, saa, date_obj, altitude=0.1)
print('Done!')
